...
<div class="publications">
  ...
  <section class="pub-section">
    ...
    <article class="pub-card">
      <div class="pub-paper">
        ...
        <h3 class="pub-title">Co-invention and knowledge transfer in science-industry collaboration: Evidence on Recombinant Novelty</h3>
        <p class="pub-authors">Si Hao Li, Anne Plunket and Felipe Starosta de Waldemar</p>
        <p class="pub-status">Accepted for presentation at the 8th Geography of Innovation Conference (2025)</p>
    ...
    <article class="pub-card">
      <div class="pub-paper">
        <p class="pub-kicker">Working Paper</p>
        <h3 class="pub-title"><a href="https://papers.ssrn.com/sol3/papers.cfm?abstract_id=5011043">What are economists telling us in the top 5? A Structural Topic Models approach</a></h3>
        <p class="pub-authors">Si Hao Li</p>
        <p class="pub-status">2025</p>
        <p class="pub-links"><a href="https://github.com/sihao-li/Top-Five-journal-of-economics">Data and code</a></p>
        <details class="pub-abstract">
          <summary>Abstract</summary>
  ...
  <section class="pub-section">
    ...
    <article class="pub-card">
      <div class="pub-paper">
        <p class="pub-kicker">Work in Progress</p>
        <h3 class="pub-title">Second-Degree Price Discrimination in Digital Goods: Grey Markets and Conflict</h3>
    ...
    <article class="pub-card">
      <div class="pub-paper">
        <p class="pub-kicker">Work in Progress</p>
        <h3 class="pub-title">Mobile Money, Interoperability and Competition</h3>
  ...
  <section class="pub-section">
    ...
    <article class="pub-card">
      <div class="pub-paper">
        ...
        <p class="pub-authors">Si Hao Li</p>
        <p class="pub-status">Supervised by Marc Bourreau</p>
        <details class="pub-abstract">
          <summary>Abstract</summary>
